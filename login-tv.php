...
$msg = (isset($_GET["msg"]))? "Η εγγραφή σας πραγματοποιήθηκε με επιτυχία." :"";
...
<div style="color:yellow;font-size:20px"><?php
echo $msg;
?></div>
  <div class="container">
...
<div style="text-align: center;">
	...
	<button style="width:215px!important;float: none; margin-left: 10px;" id="back" type="" onclick="location.href='index.php?action=edit';">Ο λογαριασμός μου</button>
</div>
